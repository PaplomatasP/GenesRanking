...
#'
#' This function performs ontology analysis using clusterProfiler. The user
#' provides a set of important features (e.g., genes), the ontology type to be
#' used (e.g., "KEGG", "GO", "MKEGG"), and the organism (e.g., "human" or "mouse").
#'
#' @param Important_Features A character vector containing the names of the
#'   important features (e.g., genes)
#' @param ontology_type A character string indicating the ontology type to be
#'   used. It can be one of the following: "KEGG" (default), "GO", "MKEGG".
#' @param organism A character string indicating the organism to be used. It can
#'   be either "human" (default) or "mouse".
...
#'   Important_Features <- FilterData$Important_Features,
#'   ontology_type <- "MKEGG",
#'   organism <- "mouse"
#' )
Ontology_Analysis <- function(Important_Features,
                              ontology_type = "KEGG",
                              organism = "human") {
  if (organism == "human") {
    org_db <- org.Hs.eg.db
