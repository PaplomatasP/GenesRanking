...
#Statistical_Filter 
StatisticalFilter <- Statistical_Filter(data_filtered, Pvalue_md = "Waldtest", Labels = Labels, n_genes_to_keep = 100)

#Non_Tree_Based_ML
result_Non_Tree_Based_ML <- Non_Tree_Based_ML(data_filtered, Labels=Labels, MLmethod = "knn",  n_genes_to_keep = 100)

#Tree_Based_ML
result_Tree_Based_ML <- Tree_Based_ML(data_filtered, Labels=Labels, MLmethod = "C5.0", n_genes_to_keep = 100)
...
OntologyAnalysis= Ontology_Analysis(Important_Features = FilterData$Important_Features[1:10],
                                                            ontology_type = "GO",
                                                            organism = "mouse")
